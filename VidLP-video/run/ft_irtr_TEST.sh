...
exp_name=drama_ft_irtr_TEST
debug=False
# load_path="result/drama_ft_irtr_seed0_from_/version_0/checkpoints/**.ckpt" # model weights after pretraining + irtr fintuning
load_path="result/drama_ft_irtr_seed0_from_/version_2/checkpoints/epoch_009-step_000388-val_score_0.82.ckpt"
# load_path=''
