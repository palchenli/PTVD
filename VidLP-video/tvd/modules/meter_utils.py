...
from .objectives import compute_irtr_recall, compute_mlm_caption
...
def epoch_wrapup(pl_module):
    ...
    if pl_module.hparams.config["get_mlm_caption_metric"] and not pl_module.training:
        ...
        pl_module.logger.experiment.add_scalar("caption/b4", b4, pl_module.global_step)
        pl_module.logger.experiment.add_scalar("caption/meter", m, pl_module.global_step)
        pl_module.logger.experiment.add_scalar("caption/cider", c, pl_module.global_step)
        pl_module.logger.experiment.add_scalar("caption/spice", s, pl_module.global_step)
        the_metric += c + m
