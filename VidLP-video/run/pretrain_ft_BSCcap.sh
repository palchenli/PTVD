...
exp_name=drama_pt_ft_BSCcap
debug=False

load_path="result/drama_pt_seed0_from_/version_0/checkpoints/epoch_013-step_001794-val_score_1.45.ckpt" 
...
config_path=`python generate_configs.py with data_root=${DATA_ROOT} num_gpus=$_num_gpus num_nodes=$_num_nodes $config_name \
    per_gpu_batchsize=$per_gpu_batchsize val_check_interval=0.25 exp_name=$exp_name debug=$debug load_path=$load_path gt_caption_anno_path=/group/30042/palchenli/projects/meter_pretrain/dataset_cn/drama/metadata/wt_split/pretrain_test_coco_style_spaced_multi_5.json learning_rate=0.00003 max_epoch=2 `
